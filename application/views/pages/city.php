    		...
    		<div class="row">
    			...
    			<div class="col-md-8">
			    	...
			    	<div class="section-content">
    					...
    					<div class="content-header">
	    					<h1 class="section-title"><h2 class="section-title">Zip Codes in <br class="visible-xs" /><strong><?php echo $city_data->name.', '.strtoupper($city_data->state); ?></strong></h2></h1>
	    				</div>

	    				<div class="service-image data-img" data-bg="<?php echo base_url($banner_img); ?>">
    					...
    					<div class="zips-wrap">
    						...
    						<?php
    							...
    							foreach($zipcode as $zips) {
    								$zip_code = trim('<a class="chip" href="'.base_url('zip/'.$zips).'" >'.$zips.'</a>', '/,([\s])+/');
    								echo $zip_code;
    							}
